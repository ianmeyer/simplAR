...
public class GvrView2 extends FrameLayout {
    /**
     * Copy of {@link GvrView}
     * with added access to GvrSurfaceView
     *
     * @return
     */
    public GvrSurfaceView getGvrSurfaceView() {
        return this.cardboardViewApi.getGvrSurfaceView();
    }

    /**
     * Original {@link GvrView} code:
     */
    private CardboardViewApi cardboardViewApi;

    public GvrView2(Context context) {
        super(context);
        this.init(context);
    }

    public GvrView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context);
    }
